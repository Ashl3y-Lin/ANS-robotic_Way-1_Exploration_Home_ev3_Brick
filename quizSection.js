...
const questions = [
    {
        question: "What is the function of the EV3 brick in LEGO Mindstorms robotics?" ,
        answers: [
            {text: "Provides power to the motors", correct: false}, 
            {text: "Acts as the brain of the robot", correct: true}, 
        ]
    },
    {
        question: "How can you exit a program with only the brick?" ,
        answers: [
            {text: "With [up] button", correct: false}, 
            {text: "With [center] button", correct: false}, 
            {text: "With [cancel] button", correct: true}, 
            {text: "With [right] button", correct: false}, 
        ]
    },
    {
        question: "How can you start a program with only the brick?" ,
        answers: [
            {text: "With [up] button", correct: false}, 
            {text: "With [center] button", correct: true}, 
            {text: "With [cancel] button", correct: false}, 
            {text: "With [right] button", correct: false}, 
        ]
    },
